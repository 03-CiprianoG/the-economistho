...
<bold>Simple authentication system</bold>

By using mongoose, passport and express-session the user is able to signup, login and authenticate himself.
_The Application won't show any data if the user is not logged in._ (assignment rule).

<bold>Web scraping system</bold>
...
<bold>The Application does not actually needs the scraped data but it was required for the assignment</bold> (assignment rule).

<bold>Cloning system</bold>
